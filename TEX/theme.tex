...
\begin{minipage}{0.25\paperwidth} %
	...
	\includegraphics[height=1.2cm]{logos/Uni-logo-Glasgow_730_290_80.jpg}\hspace*{1pt} %
\end{minipage} %
...
\pgfdeclareimage[height=1.5cm]{UoG}{logos/Uni-logo-Glasgow_730_290_80.jpg}
...
\defbeamertemplate*{title page}{MagdeburgFIN}[1][]
{
   ...
   \vskip2.0em
	\begin{pgfpicture}[sep=0cm,#1]
		\hspace{20pt}
		\pgftext[at=\pgfpoint{0pt}{100pt},left,base]{\pgfuseimage{UoG}}
	\end{pgfpicture}
   \vskip1.8em
