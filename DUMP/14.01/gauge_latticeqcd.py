...
def generate(beta, u0, action, Nt, Nx, Ny, Nz, startcfg, Ncfg, Nfluc, thermal, Nhits, Nmatrix, epsilon, Nu0_step='', Nu0_avg = 10):    
    ...
    acceptance = U.markov_chain_sweep(epsilon, Ncfg, Nfluc, matrices, startcfg, name, thermal, Nhits, action, Nu0_step, Nu0_avg)
...
class lattice():
    ...
    def deltaSEH(self, link, updated_link, staple, SP, SPrime, t, x, y, z):
        ...
        Jack=Relative_tools.inv_Jack(SPrime, 0, 0, 0, 0)
        return 1
    ...
    def markov_chain_sweep(self, epsilon, Ncfg, Nfluc, matrices, initial_cfg=0, save_name='', thermal=10, Nhits=10, action='W', Nu0_step='', Nu0_avg=10):
        ratio_accept = 0.
                            ...
                            for z in range(self.Nz):
                                ...
                                for mu in range(4):
                                    ...
                                    for j in range( Nhits ):
                                        ...
                                        Uprime = np.dot(matrix, self.U[t, x, y, z, mu, :, :])
                                        ### calculate staple
                                        #dS = self.deltaS(self.U[t, x, y, z, mu, :, :], Uprime, A) Unsure if needed in this part. Maybe.
                                        ### check if U' accepted
